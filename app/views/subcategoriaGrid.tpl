...
{literal}
	...
	<script type="text/javascript" language="javascript">
		...
		config.url    	= '{/literal}{$basePath}{literal}subcategoria/dados';
		config.form   	= '{/literal}{$basePath}{literal}subcategoria/form';
		config.excluir  = '{/literal}{$basePath}{literal}subcategoria/excluir';
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<a class="pull-right btn btn-primary btn-xs" href="{$basePath}subcategoria/form">
